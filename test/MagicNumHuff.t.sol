...
contract MagicNumHuffTest is Test {
    ...
    function testMagicNumHack() public {
        ...
        /* Level Hack */
        // HuffDeployer.deploy() needs to prank HuffConfig
        // Hence previous eoa prank would interfere. So stopping it here for now.
        vm.stopPrank();
        
        // Deploy Huff contract
        address solverAddr = HuffDeployer.deploy("levels/MagicNumHack");
