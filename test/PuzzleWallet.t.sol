...
contract PuzzleWalletTest is Test {
    ...
    function testPuzzleWalletHack() public {
        /* Level Setup */
        // Deploy level factory: PuzzleWalletFactory
        ...
        ethernaut.createLevelInstance{value: 0.001 ether}(puzzleWalletFactory);
        ...
        Vm.Log memory levelPuzzleWalletCreatedLog = entries[0];

        // Cast bytes32 log arg into address
        address instanceAddress = address(
            uint160(uint256(levelPuzzleWalletCreatedLog.topics[2]))
        );
