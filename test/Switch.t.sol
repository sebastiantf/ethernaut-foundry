...
contract SwitchTest is Test {
    ...
    function testSwitchHack() public {
        /* Level Setup */
        // Deploy level factory: SwitchFactory
        ...
        ethernaut.createLevelInstance{value: 0.001 ether}(switchFactory);
        ...
        Vm.Log memory levelSwitchCreatedLog = entries[0];

        // Cast bytes32 log arg into address
        address instanceAddress = address(
            uint160(uint256(levelSwitchCreatedLog.topics[2]))
        );
