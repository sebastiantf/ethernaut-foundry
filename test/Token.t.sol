...
contract TokenTest is Test {
    ...
    function testTokenHack() public {
        /* Level Setup */
        // Deploy level factory: TokenFactory
        ...
        ethernaut.createLevelInstance(tokenFactory);
        ...
        Vm.Log memory levelTokenCreatedLog = entries[0];

        // Cast bytes32 log arg into address
        address instanceAddress = address(
            uint160(uint256(levelTokenCreatedLog.topics[2]))
        );
